...
<div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components mb-5">
            ...
            <li>
                <a href="/psikiater/profil"><span class="fa fa-user-circle mr-3"></span> Profil</a>
            </li>
            <li>
